...
class cafe_management():
        ...
        def __init__(self):
                ...
                self.heading = Label(self.root,text="  Cafe Management System",font=('Constania',20),fg="#000000",bg="white")
                ...
                self.tea = Label(self.frame1,text="Tea",font=('constanian',10,'bold'),bg="white")
                ...
                self.Total_Bills_btn.place(x=440,y=235)
                ...
                self.Clear_btn.place(x=440,y=270)
